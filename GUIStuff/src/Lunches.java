...
public class Lunches {
    ...
    public Lunches(Stage primaryStage) {
        ...
        Label heading2 = new Label("Summer Lunch Program");
        ...
        buttons.add(new Button("" + SummerLunches.enumTitle(1)));
        ...
        buttons.get(0).setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent e) {
                ...
                Text info = new Text(SummerLunches.enumBody(1));
                Text title = new Text(SummerLunches.enumTitle(1));
