...
public class Education {
    ...
    Button college;
    Button back;
    public Education(Stage primaryStage) {
        ...
        library.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                Library GUI = new Library(primaryStage);
        ...
        college.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent event) {
                College GUI = new College(primaryStage);
                Scene scene2 = new Scene(GUI.getBpane(), 800, 700);
                primaryStage.setScene(scene2);
                primaryStage.show();
            }
